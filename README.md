...
> Radar for SaaS sprawl from SSO logs

**Author:** zAx4hub

## Problem

Radar for SaaS sprawl from SSO logs. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`saas-sprawl-radar` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **routing** engine, CLI, examples, and tests.
